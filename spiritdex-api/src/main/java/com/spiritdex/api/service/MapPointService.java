...
import com.spiritdex.api.mapper.MapTextLayerMapper;
...
/**
 * 地图点位 Service（纯展示）。支持按类型筛选 + 类型聚合统计 + 文字图层。
 */
@Service
@RequiredArgsConstructor
public class MapPointService extends ServiceImpl<MapPointMapper, MapPoint> {

    private final MapTextLayerMapper mapTextLayerMapper;
    ...
    /** 全部文字图层（地名标注）。 */
    public List<MapTextLayer> textLayers() {
        return mapTextLayerMapper.selectList(null);
    }
}
